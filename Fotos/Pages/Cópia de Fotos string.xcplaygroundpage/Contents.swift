...
class MyCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        shineImageView.contentMode = UIViewContentMode.scaleAspectFit
...
class CollectionViewController : UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    private var fotos: [UIImage] =  [#imageLiteral(resourceName: "Imagem JPEG 2.jpeg"),#imageLiteral(resourceName: "Imagem JPEG 3.jpeg"),#imageLiteral(resourceName: "Imagem JPEG 4.jpeg"),#imageLiteral(resourceName: "Imagem PNG.png"),#imageLiteral(resourceName: "Imagem JPEG 5.jpeg")]
